...
public class IntegrationItemTest {
    ...
    public void beforeEach() {
        item1 = new Item(null, "бензопила", "все люди делятся на две половины", true, null, null);
    ...
    void findAllByOwnerIdTest() {
        ...
        User newUser = userRepository.findById(responseUser.getBody().getId()).get();
        ...
        List<Item> itemsFromDB = itemRepository
                .findAllByOwnerIdOrderById(responseUser.getBody().getId(), PageRequest.of(0, 10)).toList();
