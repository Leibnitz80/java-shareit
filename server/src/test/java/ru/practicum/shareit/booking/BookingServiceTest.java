...
public class BookingServiceTest {
    ...
    public void createBookingTest() {
        ...
        when(itemRepository.existsById(any(Long.class)))
                .thenReturn(true);
    ...
    public void approveBookingTest() {
        ...
        when(bookingRepository.existsById(any(Long.class)))
                .thenReturn(true);
    ...
    public void findAllByBookerStateRejectedTest() {
        ...
        List<BookingDto> result = bookingService.getAllByUser(1L, "REJECTED", 0, 10);
    ...
    public void findAllByBookerStateWaitingTest() {
        ...
        List<BookingDto> result = bookingService.getAllByUser(1L, "WAITING", 0, 10);
    ...
    public void findAllByBookerStateCurrentTest() {
        ...
        List<BookingDto> result = bookingService.getAllByUser(1L, "CURRENT", 0, 10);
    ...
    public void findAllByBookerStateFutureTest() {
        ...
        List<BookingDto> result = bookingService.getAllByUser(1L, "FUTURE", 0, 10);
    ...
    public void findAllByBookerStatePastTest() {
        ...
        List<BookingDto> result = bookingService.getAllByUser(1L, "PAST", 0, 10);
    ...
    public void findAllByItemOwnerStateWaitingTest() {
        ...
        List<BookingDto> result = bookingService.getAllByOwner(1L, "WAITING", 0, 10);
    ...
    public void findAllByItemOwnerStateCurrentTest() {
        ...
        List<BookingDto> result = bookingService.getAllByOwner(1L, "CURRENT", 0, 10);
    ...
    public void findAllByItemOwnerStateFutureTest() {
        ...
        List<BookingDto> result = bookingService.getAllByOwner(1L, "FUTURE", 0, 10);
    ...
    public void findAllByItemOwnerStatePastTest() {
        ...
        List<BookingDto> result = bookingService.getAllByOwner(1L, "PAST", 0, 10);
    ...
    public void findAllByItemOwnerStateAllTest() {
        ...
        List<BookingDto> result = bookingService.getAllByOwner(1L, "ALL", 0, 10);
    ...
    public void findAllByItemOwnerStateRejectedTest() {
        ...
        List<BookingDto> result = bookingService
                .getAllByOwner(1L, "REJECTED", 0, 10);
    ...
    public void findAllByBookerUnsupportedStatus() {
        BadRequestException e = assertThrows(BadRequestException.class,
                () -> {
                    bookingService.getAllByUser(1L, "UNSUPPORTED", 0, 10);
                });
    ...
    public void createBookingWrongOwnerTest() {
        when(userRepository.existsById(any(Long.class)))
                .thenThrow(new ObjectNotFoundException("User with id = 1L not found error"));
    ...
    public void createBookingWrongItemTest() {
        ...
        when(itemRepository.existsById(any(Long.class)))
                .thenThrow(new ObjectNotFoundException("Item with id = 1L not found error"));
