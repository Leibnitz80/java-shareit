...
public class BookingControllerTest {
    ...
    public void getAllByUserTest() {
        when(bookingService.getAllByUser(any(Long.class), any(String.class), any(Integer.class), any(Integer.class)))
        ...
        verify(bookingService, times(1))
                .getAllByUser(any(Long.class), any(String.class), any(Integer.class), any(Integer.class));
    }
    ...
    public void getAllByOwnerTest() {
        when(bookingService.getAllByOwner(any(Long.class), any(String.class), any(Integer.class), any(Integer.class)))
                .thenReturn(new ArrayList<>());
        ...
        verify(bookingService, times(1))
                .getAllByOwner(any(Long.class), any(String.class), any(Integer.class), any(Integer.class));
    }
}